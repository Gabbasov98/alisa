...
$(".burger").click((function(){$(".header").toggleClass("_open"),$("body").toggleClass("fixed-body")})),$("._toggle-search").click((function(){$(".header-search").toggleClass("_open")})),$(".nav__sub-link").click((function(){let e=$(this).attr("data-id");$(".catalog").find(`[data-tab='_tab${e}']`).click(),$(".header").removeClass("_open"),$("body").removeClass("fixed-body")})),$(".nav__link").click((function(){$(".header").removeClass("_open"),$("body").removeClass("fixed-body")}));
...
let localeRu={days:["Воскресенье","Понедельник","Вторник","Среда","Четверг","Пятница","Суббота"],daysShort:["ВСК","ПН","ВТ","СР","ЧТ","ПТ","СБ"],daysMin:["Вс","Пн","Вт","Ср","Чт","Пт","Сб"],months:["Январь","Февраль","Март","Апрель","Май","Июнь","Июль","Август","Сентябрь","Октябрь","Ноябрь","Декабрь"],monthsShort:["Янв","Фев","Мар","Апр","Май","Июн","Июл","Авг","Сен","Окт","Ноя","Дек"],today:"Сегодня",clear:"Очистить",dateFormat:"dd.MM.yyyy",timeFormat:"HH:mm",firstDay:1};function fix100vh(){let e=.01*window.innerHeight;document.documentElement.style.setProperty("--vh",e+"px")}window.addEventListener("DOMContentLoaded",()=>{fix100vh(),window.addEventListener("resize",()=>{fix100vh(),getScrollBarSize()}),getScrollBarSize();let e=new Date;new AirDatepicker(".date-input",{locale:localeRu,inline:!0,autoClose:!0,startDate:e,selectedDates:[e],onSelect:e=>{$(".time-field__date").html(e.formattedDate)}});$(".time-field__date").html(e.toLocaleDateString("ru-Ru")),$(".time-field").click((function(){$(".time").toggleClass("_open")})),$(".hours-picker__item").click((function(){$(".hours-picker__item").removeClass("_active"),$(this).addClass("_active"),$(".time-field__time").html($(this).attr("data-time"))})),$(".time-field__time").html($(".hours-picker__item._active").attr("data-time")),$(".time-modal__btn").click((function(){$(".time-field").addClass("_active"),$(".time").removeClass("_open")})),$(document).mouseup((function(e){var t=$(".time");t.is(e.target)||0!==t.has(e.target).length||$(t).hasClass("_open")&&$(t).removeClass("_open")}))});
